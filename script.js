...
checkoutBtn.addEventListener("click", function(){
   const isOpen = chackRestauranteOpen();
     if(!isOpen){
       Toastify({
    ...
    const phone = "41992533112"
window.open(`https://wa.me/${phone}?text=${messagem} Endereço: ${addressInput.value}`, "_blank")
cart = [];
updateCartModal();
})
function chackRestauranteOpen(){
    const data = new Date();
